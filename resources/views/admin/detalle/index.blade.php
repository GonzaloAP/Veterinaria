                                ...
                                @foreach($detalle as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/detalle/' . $item->idFicha . '/edit') }}" title="Edit Detalle"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
